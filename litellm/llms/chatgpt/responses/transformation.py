...
class ChatGPTResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def _has_convertible_output_item(cls, output_items: Any) -> bool:
        ...
        for item in output_items:
            ...
            if any(cls._get_output_item_value(content_item, "type") == "output_text" for content_item in content_items):
                return True
        return False
    ...
    def _merge_completed_output_items(
        ...
        existing_ids = {
            item_id for item in merged if isinstance(item_id := cls._get_output_item_value(item, "id"), str) and item_id
        }
    ...
    def _build_completed_response_from_chunk(
        ...
        if streamed_output_items:
            ...
            if not self._has_convertible_output_item(output_items):
